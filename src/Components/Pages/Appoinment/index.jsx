  ...
  return (
    <div>
      <div className="dp-section1 flex flex-col items-center justify-center text-white h-[70vh]">
        <h1 className="text-2xl lg:text-5xl">DOCTOR'S APPOINTMENT</h1>
      ...
      <div className="flex items-center justify-center text-center  text-[#124574] ">
        <div className="flex flex-col items-center justify-center h-[50vh] lg:h-[70vh] lg:w-[50%] my-10 mx-5">
          <h1 className="text-2xl lg:text-5xl my-5">BOOK ONLINE</h1>
          <div className="flex items-center justify-center flex-col gap-4">
            ...
            <p className="">It's simple, quick, and hassle-free!</p>
          </div>
        </div>
      </div>
